...
export default function IssueRow({
  ...
  const isDragOverTarget = issue.id === rowDragOverId && draggedRowId !== null && issue.id !== draggedRowId;
  ...
  return (
    ...
    >
      ...
      <TableCell
        className={cn(
            "w-32 text-center align-top pt-4", 
            getCellClasses(3) 
        )}
        onMouseDown={(e) => onCellMouseDown(rowIndex, 3, e)} 
        onMouseEnter={() => onCellMouseEnter(rowIndex, 3)}
      >
        <div className="flex flex-col items-center gap-1.5" onClick={stopPropagation} onMouseDown={stopPropagation}>
